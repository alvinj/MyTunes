...
public class JLayerPlayerPausable {
  ...
  public boolean play(int frameIndexStart, int frameIndexFinal, int correctionFactorInFrames)
    ...
    this.audioDevice = (JavaSoundAudioDevice)FactoryRegistry.systemRegistry().createAudioDevice();
    ...
    if (this.listener != null) {
      this.listener.playbackStarted(new PlaybackEvent(this,
          PlaybackEvent.EventType.Instances.Started, this.audioDevice.getPosition()));
    }
    ...
    if (this.audioDevice != null) {
      ...
      if (this.listener != null) {
        this.listener.playbackFinished(new PlaybackEvent(this,
            PlaybackEvent.EventType.Instances.Stopped, this.audioDevice.getPosition()));
      }
    }
